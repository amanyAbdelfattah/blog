...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <h5 class="text-center" style="padding-top: 23px; color:white; font-weight:600">Hi, {{ Auth::user()->name }}</h5>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('jobreq.index')}}"><i class="fas fa-address-card"></i> Applicant Requests</a>
            </div>
        </div>
    </li>
    <!--End User Tab-->
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{route('service.index')}}"><i class="fas fa-couch"></i> All Services</a>
                <a class="collapse-item" href="{{route('service.create')}}"><i class="fas fa-plus-circle"></i> Add Service</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{route('categories.index')}}"><i class="fas fa-shopping-basket"></i> All Categories</a>
                <a class="collapse-item" href="{{route('categories.create')}}"><i class="fas fa-plus-circle"></i> Add Category</a>
            </div>
        </div>
    </li>
