...
<div class="main">
    ...
    <div id="navbar">
        <div class="navigation-example" style="background-image: url('{{URL::asset('userinterface/assets/img/ilya-yakover.jpg')}}');">
        <nav class="navbar navbar-expand-lg bg-primary">
            <div class="container">
    ...
    <div id="images">
        ...
        <div class="row">
            ...
            <img src="{{URL::asset('userinterface/assets/img/uriel-soberanes.jpg')}}" class="img-rounded img-responsive" alt="Rounded Image">
            <div class="img-details">
                <div class="author">
                <img src="{{URL::asset('userinterface/assets/img/faces/joe-gardner-2.jpg')}}" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                </div>
                <p>Sonia Green </p>
            </div>
            </div>
            ...
            <img src="{{URL::asset('userinterface/assets/img/faces/kaci-baum-2.jpg')}}" class="img-circle img-no-padding img-responsive" alt="Rounded Image">
            <p class="text-center">Brigitte Bardot</p>
            </div>
            <div class="col-sm-3 col-md-2 mr-auto">
            <h4 class="images-title">Thumbnail</h4>
            <img src="{{URL::asset('userinterface/assets/img/faces/erik-lucatero-2.jpg')}}" class="img-thumbnail img-responsive" alt="Rounded Image">
        ...
        <div class="col-md-8 ml-auto mr-auto">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-item active">
                    <img class="d-block img-fluid" src="{{URL::asset('userinterface/assets/img/soroush-karimi.jpg')}}" alt="First slide">
                    <div class="carousel-caption d-none d-md-block">
                    <p>Somewhere</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block img-fluid" src="{{URL::asset('userinterface/assets/img/federico-beccari.jpg')}}" alt="Second slide">
                    <div class="carousel-caption d-none d-md-block">
                    <p>Somewhere else</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="d-block img-fluid" src="{{URL::asset('userinterface/assets/img/joshua-stannard.jpg')}}" alt="Third slide">
                    <div class="carousel-caption d-none d-md-block">
                    <p>Here it is</p>
                    </div>
                </div>
    ...
    <div class="section section-image section-login" style="background-image: url('{{URL::asset('userinterface/assets/img/login-image.jpg')}}');">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="col-md-6 text-center">
            ...
            <img src="{{URL::asset('userinterface/assets/img/examples/landing-page.png')}}" alt="Rounded Image" class="img-rounded img-responsive" style="width: 100%">
            <a href="./examples/landing-page.html" class="btn btn-outline-neutral btn-round" target="_blank">Landing Page</a>
            </a>
        </div>
        <div class="col-md-6 text-center">
            <a href="examples/profile.html" target="_blank">
            <img src="{{URL::asset('userinterface/assets/img/examples/profile-page.png')}}" alt="Rounded Image" class="img-rounded img-responsive" style="width: 100%">
